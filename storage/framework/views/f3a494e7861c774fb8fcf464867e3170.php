<?php echo e(Form::open(['url' => route('campaigns.store'), 'enctype' => 'multipart/form-data'])); ?>
...
<div class="row">
  ...
  <div class="form-group col-md-12">
        ...
        <?php echo e(Form::text('name', null, ['class' => 'form-control font-style', 'required' => 'required', 'placeholder' => 'Enter Campaigns Name'])); ?>
...
unset($__errorArgs, $__bag); ?>
        <small><a href="<?php echo e(route('category.index')); ?>"><?php echo e(__('You can add new category from here')); ?></a></small>
    </div>
    ...
    <div class="col-6 form-group">
        <?php echo e(Form::label('Start Date', __('Start Date'), ['class' => 'form-control-label'])); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-6 form-group">
        <?php echo e(Form::label('End Date', __('End Date'), ['class' => 'form-control-label'])); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-6 form-group">
        ...
        <?php echo e(Form::number('total_days', null, ['class' => 'form-control total_days', 'readonly' => 'readonly'])); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-6 form-group">
        ...
        <?php echo e(Form::number('total_cost', null, ['class' => 'form-control total_cost', 'readonly' => 'readonly'])); ?>
...
<?php /**PATH /home/vcard/public_html/resources/views/campaigns/create.blade.php ENDPATH**/ ?>