...
?>
<?php echo e(Form::open(['route' => ['contact.note.store', $contact->id]])); ?>
...
<div class="row">
    ...
    <div class="col-12 form-group mt-4">
        <div class="row gutters-xs">
            ...
            <div class="col-12">
                <textarea class="summernote" row="10" cols="50" id="note" name="note"><?php echo $contact->note; ?></textarea>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH /home/vcard/public_html/resources/views/contacts/add_note.blade.php ENDPATH**/ ?>