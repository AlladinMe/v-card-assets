...
<div class="row">
    <div class="col-md-6">
        <div class="form-group ">
            ...
            <?php echo e(Form::text('name',null,array('class'=>'form-control font-style','placeholder' => __('Enter ' . (Auth::user()->type === 'super admin' ? 'Company' : 'User') . ' Name')))); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <?php echo e(Form::text('email',null,array('class'=>'form-control','placeholder' => __('Enter ' . (Auth::user()->type === 'super admin' ? 'Company' : 'User') . ' Email')))); ?>
...
<?php echo e(Form::close()); ?><?php /**PATH /home/vcard/public_html/resources/views/user/edit.blade.php ENDPATH**/ ?>