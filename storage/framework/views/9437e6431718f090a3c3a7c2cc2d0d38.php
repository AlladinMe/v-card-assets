...
<div class="row">
    ...
    <div class="col-12 form-group mt-4">
        <div class="row gutters-xs">
            ...
            <div class="col-12">
                <textarea class="summernote" id="note" rows="10" cols="50" name="note"><?php echo $appointment->note; ?></textarea>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH /home/vcard/public_html/resources/views/appointments/add_note.blade.php ENDPATH**/ ?>