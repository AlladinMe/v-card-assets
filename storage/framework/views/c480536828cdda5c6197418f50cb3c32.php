...
<div class="row">
    ...
    <div class="form-group col-md-6">
        ...
        <?php echo e(Form::number('max_users', null, ['class' => 'form-control', 'placeholder' => __('Enter Max User Create Limit'), 'min' => '-1'])); ?>
    ...
    <div class="form-group col-md-6">
        ...
        <?php echo e(Form::number('business', null, ['class' => 'form-control', 'placeholder' => __('Enter Max Business Create Limit'), 'min' => '-1'])); ?>
...
<?php /**PATH /home/vcard/public_html/resources/views/plan/edit.blade.php ENDPATH**/ ?>