        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body table-border-style">
                    <div class="row">
                        <div
                            class="col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12 d-lg-flex gap-3 align-items-end mb-3 mb-md-0">
                                    ...
                                    <div class="dropdown-menu dash-h-dropdown dropdown-menu-end page-inner-dropdowm">
                                        <?php $__currentLoopData = $businesses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $business): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($business['admin_enable'] == 'on'): ?>
                                                <a href="<?php echo e(route('business.change', $business['id'])); ?>"
                                                    class="dropdown-item">
                                                    <i
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit appointment')): ?>
                                                    <div class="action-btn bg-success  ms-2">
                                                        <a href="#"
                                                            ...
                                                            data-url="<?php echo e(route('appointment.add-note', $val->id)); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vcard/public_html/resources/views/appointments/index.blade.php ENDPATH**/ ?>