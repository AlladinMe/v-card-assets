    ...
    <div class="col-6 form-group">
        <div class="row nfc-card-price">
            ...
            <div class="price-best-price">
                <strong
                    id="skuBestPrice"><?php echo e($nfcCard->price); ?> <?php echo e(!empty($admin_payment_setting['CURRENCY_SYMBOL']) ? $admin_payment_setting['CURRENCY_SYMBOL'] : '$'); ?></strong>
...
<script>
    ...
    $(document).ready(function() {
        function updatePrice() {
            ...
            $("#total-price").text(total+" "+currency);
...
<?php /**PATH /home/vcard/public_html/resources/views/nfc/addtocart.blade.php ENDPATH**/ ?>