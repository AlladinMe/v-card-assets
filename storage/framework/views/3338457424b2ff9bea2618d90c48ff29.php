...
<body class="<?php echo e($themeColor); ?>">
    ...
    <footer class="dash-footer">
        <div class="footer-wrapper">
            <div class="py-1">
                <p class="">
                    &copy;&nbsp;<?php echo e(date('Y')); ?>&nbsp;<?php echo e(isset($langSetting['footer_text']) ? $langSetting['footer_text'] : config('app.name', 'V-Card.ro')); ?>
...
<?php /**PATH /home/vcard/public_html/resources/views/layouts/admin.blade.php ENDPATH**/ ?>