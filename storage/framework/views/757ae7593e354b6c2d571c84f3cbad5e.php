                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit user')): ?>
                                        <?php if(Auth::user()->type == 'super admin'): ?>
                                            <a href="#" class="dropdown-item user-drop"
                                                ...
                                                data-title="<?php echo e(__('Update Company')); ?>"><i class="ti ti-edit"></i><span
                                    ...
                                    <?php elseif($user->is_enable_login == 0 && $user->password == null): ?>
                                        <a href="#" data-url="<?php echo e(route('user.reset', \Crypt::encrypt($user->id))); ?>"
                                            ...
                                            class="dropdown-item login_enable user-drop"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vcard/public_html/resources/views/user/index.blade.php ENDPATH**/ ?>