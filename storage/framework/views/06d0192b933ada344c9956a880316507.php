                                ...
                                <?php if($domain_request->count() > 0): ?>
                                    <?php $__currentLoopData = $domain_request; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prequest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="font-style font-weight-bold"><?php echo e($prequest->business->title); ?>

                                                </div>
                                            </td>
                                            <td>
                                                <div class="font-style font-weight-bold"><?php echo e($prequest->domain_name); ?></div>
                                            </td>
                                            <td>
                                                <?php if($prequest->status == 0): ?>
                                                    <span
                                                        class="badge fix_badges bg-danger p-2 px-3 rounded"><?php echo e(__(App\Models\DomainRequest::$statues[$prequest->status])); ?></span>
                                                <?php elseif($prequest->status == 1): ?>
                                                    <span
                                                        class="badge fix_badges bg-primary p-2 px-3 rounded"><?php echo e(__(App\Models\DomainRequest::$statues[$prequest->status])); ?></span>
                                                <?php elseif($prequest->status == 2): ?>
                                                    <span
                                                        class="badge fix_badges bg-warning p-2 px-3 rounded"><?php echo e(__(App\Models\DomainRequest::$statues[$prequest->status])); ?></span>
                                                <?php endif; ?>
                                            </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vcard/public_html/resources/views/domain_request/index.blade.php ENDPATH**/ ?>