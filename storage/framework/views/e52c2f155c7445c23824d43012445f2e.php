    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('screenshots_heading',$screenshot['screenshots_heading'], ['class' => 'form-control ', 'placeholder' => __('Enter Heading')])); ?>
...
<?php /**PATH /home/vcard/public_html/Modules/LandingPage/Resources/views/landingpage/screenshots/edit.blade.php ENDPATH**/ ?>