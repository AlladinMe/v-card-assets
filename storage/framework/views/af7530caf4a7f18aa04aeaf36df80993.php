                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $orderRequest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($order->price); ?> Lei</td>
                                            <td>
                                                ...
                                                <?php elseif($order->approval == '0'): ?>
                                                    <span
                                                        class="badge fix_badge bg-danger  p-2 px-3 rounded"><?php echo e(__('Rejected')); ?></span>
                                                <?php else: ?>
                                                    <span
                                                        class="badge fix_badge bg-warning  p-2 px-3 rounded"><?php echo e(__('Pending')); ?></span>
                                                <?php endif; ?>
                                    ...
                                    <?php $__currentLoopData = $orderRequest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($order->approval == '1'): ?>
                                                    <span
                                                        class="badge fix_badge bg-info  p-2 px-3 rounded"><?php echo e(ucFirst($order->status)); ?></span>
                                                <?php elseif($order->approval == '0'): ?>
                                                    <span
                                                        class="badge fix_badge bg-danger  p-2 px-3 rounded"><?php echo e(__('Rejected')); ?></span>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vcard/public_html/resources/views/nfc/orderdetail.blade.php ENDPATH**/ ?>