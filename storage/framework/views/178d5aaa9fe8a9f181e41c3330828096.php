...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
        <ul class="dash-navbar">
            ...
            <?php endif; ?>
            <?php if(\Auth::user()->type != 'super admin' && $eon == 'on'): ?>
            <li
                class="dash-item <?php echo e(\Request::route()->getName() == 'marketplace' || \Request::route()->getName() == 'marketplace' ? 'active' : ''); ?>">
                <a href="<?php echo e(route('marketplace.home')); ?>" class="dash-link"><span class="dash-micon"><i
            ...
            <?php if(Auth::user()->type == 'super admin'): ?>
                ...
                <li class="dash-item <?php echo e(Request::segment(1) == 'order' ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('order.index')); ?>" class="dash-link"><span class="dash-micon"><i
                            ...
                            class="dash-mtext"><?php echo e(__('Comenzi')); ?></span></a>
           ...
           <?php if(Auth::user()->type == 'super admin'): ?>
            ...
            <?php if(Auth::user()->type == 'company' && in_array($users->plan, [3, 4])): ?>
                <li class="dash-item <?php echo e(Request::route()->getName() == 'reduceri.index' ? 'active' : ''); ?>">
        <a href="<?php echo e(route('reduceri.index')); ?>" class="dash-link">
            <span class="dash-micon"><i class="ti ti-tag"></i></span>
            <span class="dash-mtext"><?php echo e(__('Reduceri la parteneri')); ?></span>
        </a>
    </li>
            <?php endif; ?>
        ...
        <a href="<?php echo e(route('reduceri.index')); ?>" class="dash-link">
           ...
           <?php if(Auth::user()->type == 'company'): ?>
    <li class="dash-item <?php echo e(Request::route()->getName() == 'coduri_qr.index' ? 'active' : ''); ?>">
        <a href="<?php echo e(route('coduri_qr.index')); ?>" class="dash-link">
            <span class="dash-micon"><i class="ti ti-tag"></i></span>
            <span class="dash-mtext"><?php echo e(__('Generare Coduri QR')); ?></span>
        </a>
    </li>
<?php endif; ?>
...
<?php /**PATH /home/vcard/public_html/resources/views/partials/admin/sidemenu.blade.php ENDPATH**/ ?>