            ...
            <div class="home-wrapper force-overflow">
                <section class="client-info-section padding-top">
                    <div class="container">
                        ...
                        <p class="client-text" id="<?php echo e($stringid . '_desc'); ?>_preview"> <?php echo nl2br(e($business->description)); ?></p>
                    </div>
                </section>
                <?php $j = 1; ?>
                                                                ...
                                                                <li id="contact_<?php echo e($loop->parent->index + 1); ?>">
                                                                    <div class="justify-content-start">
                                                                        <div class="contact-label">
                                                                            <span>
                                                                                <?php if($social_key1 == 'Web_url'): ?>
                                                                                    <?php echo e(__('Web Url')); ?>

                                                                                    <?php else: ?><?php echo e(__($social_key1)); ?>
...
<?php /**PATH /home/vcard/public_html/resources/views/card/theme20/index.blade.php ENDPATH**/ ?>