                    ...
                    <?php if($j == $order_value): ?>
                        ...
                        <?php if($order_key == 'product'): ?>
                            <section class="product-section padding-top padding-bottom" id="product-div">
                                <div class="title-svg">
                                    <img src="<?php echo e(asset('custom/theme12/icon/' . $color . '/product.svg')); ?>"
                                        alt="phone" class="img-fluid">
                                </div>
                                <div class="container">
                        ...
                        <?php if($order_key == 'social'): ?>
                            <section class="social-icons-section padding-top" id="social-div">
                                <div class="title-svg">
                                    <img src="<?php echo e(asset('custom/theme12/icon/' . $color . '/share.svg')); ?>"
                        ...
                        <?php if($order_key == 'payment'): ?>
                            <section class="card-payment-section" id="payment-section">
                                <div class="title-svg">
                                    <img src="<?php echo e(asset('custom/theme12/icon/' . $color . '/credit-card.svg')); ?>"
                                        alt="user" class="img-fluid">
                                </div>
                        ...
                        <?php if($order_key == 'appinfo'): ?>
                            <section class="card-payment-section" id="app-section">
                                <div class="title-svg">
                                    <img src="<?php echo e(asset('custom/theme12/icon/' . $color . '/mobile-app.svg')); ?>"
                                        alt="user" class="img-fluid">
                                </div>
                                <div class="section-title text-center">
                    ...
                    <div class="share-card-wrapper">
                        ...
                        <div class="qr-scaner-wrapper">
                            ...
                            <ul class="card-social-icons">
                                <li><a href="https://twitter.com/share?url=<?php echo e(urlencode($url_link)); ?>&text=">
                                ...
                                <li><a href="https://www.facebook.com/sharer.php?u=<?php echo e(urlencode($url_link)); ?>"><img
                                            src="<?php echo e(asset('custom/theme12/icon/' . $color . '/facebook.svg')); ?>"
                                            alt="facebook" class="img-fluid" height="30px" width="30px"></a></li>
                                <li><a
                                        href="https://www.linkedin.com/shareArticle?url=<?php echo e(urlencode($url_link)); ?>&title="><img
                                            src="<?php echo e(asset('custom/theme12/icon/' . $color . '/linkedin.svg')); ?>"
...
<?php /**PATH /home/vcard/public_html/resources/views/card/theme12/index.blade.php ENDPATH**/ ?>