                        ...
                        <tbody>
                            <?php $__currentLoopData = $campaignsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaigns): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($campaigns->businesses->title); ?></td>
                                            ...
                                            <?php if(Auth::user()->type != 'company'): ?>
                                                ...
                                                <?php if(is_null($campaigns->approval) && !is_null($campaigns->total_cost)): ?>
                                                    <div class="action-btn bg-warning ">
                                                        <a href="#" class="btn btn-sm  btn-icon ml-0 "
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vcard/public_html/resources/views/campaigns/index.blade.php ENDPATH**/ ?>