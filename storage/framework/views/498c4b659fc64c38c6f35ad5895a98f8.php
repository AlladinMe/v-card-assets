...
<?php echo e(Form::open(['url' => route('nfc.store'),'enctype' => 'multipart/form-data'])); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-12 form-group img-validate-class">
        ...
        <div class="border col-md-4 mt-2">
            <img src="<?php echo e(asset('custom/img/placeholder-image21.jpg')); ?>" id="nfc_image" width="100%" />
        </div>
...
<?php /**PATH /home/vcard/public_html/resources/views/nfc/create.blade.php ENDPATH**/ ?>