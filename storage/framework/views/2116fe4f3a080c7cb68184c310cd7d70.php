                            ...
                            <?php if($j == $order_value): ?>
                                                    ...
                                                    <div class="service-card-inner">
                                                        ...
                                                        <?php if(!empty($content->purchase_link)): ?>
                                                            <a href="<?php echo e(url($content->purchase_link)); ?>"
                                                                ...
                                                                class="btn-secondary"><?php echo e($content->link_title); ?></a>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <?php
                                ...
                                <?php if($order_key == 'social'): ?>
                                    <section class="card-footer" id="social-div">
                                        ...
                                        <ul class="social-list" id="inputrow_socialmedia_preview">
...
<?php /**PATH /home/vcard/public_html/resources/views/card/theme1/index.blade.php ENDPATH**/ ?>