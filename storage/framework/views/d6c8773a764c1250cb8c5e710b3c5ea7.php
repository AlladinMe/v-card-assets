...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-sm-4 col-6">
                                                <div class="form-group">
                                                    <?php echo e(Form::label('Enable Landing Page', __('Enable Landing Page'), ['class' => 'form-label'])); ?>
                                            ...
                                            <div class="col-md-3 col-sm-4 col-6">
                                                <div class="form-group">
                                                    <?php echo e(Form::label('signup_button', __('Enable Sign-Up Page'))); ?>
                                            ...
                                            <div class="col-md-3 col-sm-4 col-6">
                                                <div class="form-group">
                                                    <?php echo e(Form::label('email_verification', __('Enable Email Verification'))); ?>
                                            ...
                                            <h2 class="accordion-header" id="headingThirtyFour">
                                                <button class="accordion-button" type="button"
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="form-check form-switch custom-switch-v1">
                                                            <input type="hidden" name="is_easybuzz_enabled"
                                                                value="off">
                                                            <input type="checkbox"
                                                                class="form-check-input input-primary"
                                                                name="is_easybuzz_enabled"
                                                                id="is_easybuzz_enabled"
                                                    ...
                                                    <div class="row pt-2">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input class="form-control"
                                                                placeholder="Easebuzz Enviroment Name"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group col switch-width">
                                                <label for="google_recaptcha_version" class="form-label"><?php echo e(__('Google Recaptcha Version')); ?></label>
                                                <select id="google_recaptcha_version" class="form-control choices" searchenabled="true" name="google_recaptcha_version">
                                                    <option value="v2" <?php echo e($setting['RECAPTCHA_VERSION'] == 'v2' ? 'selected' : ''); ?>><?php echo e(__('v2')); ?></option>
                                                    <option value="v3" <?php echo e($setting['RECAPTCHA_VERSION'] == 'v3' ? 'selected' : ''); ?>><?php echo e(__('v3')); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                            ...
                                            <input class="form-control "
                                                ...
                                                value="<?php echo e($setting['NOCAPTCHA_SECRET']); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vcard/public_html/resources/views/settings/admin_settings.blade.php ENDPATH**/ ?>