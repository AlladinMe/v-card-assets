                    ...
                    <div class="container">
                        <nav class="navbar navbar-expand-md  default top-nav-collapse">
                            ...
                            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="<?php echo e(url('/')); ?>" ><?php echo e($settings['home_title']); ?></a>
                                    </li>
                                    <li class="nav-item">
                                            ...
                                            <div class="row gy-3 align-items-center">
                                                <div class="col-xxl-6 col-lg-6">
                                                    <div class="d-flex flex-column flex-sm-row gap-3">
                                                        <span
                                                            class="theme-avtar avtar avtar-xl bg-light-dark rounded-1">
                                                ...
                                                <div class="col-xxl-6 col-lg-6">
                                                    <div
                                                        ...
                                                        <div class="text-end">
                                                            <b class="d-block"><?php echo e($testimonial->testimonials_user); ?>
...
<?php /**PATH /home/vcard/public_html/Modules/LandingPage/Resources/views/layouts/custompage.blade.php ENDPATH**/ ?>