                                        ...
                                        <div class="swiper-slide">
                                            <div class="category-body-div">
                                                ...
                                                <div class="category-name">
                                                    <h6>{{ $category->name }}</h6>
                                                    <span>{{ $category->count . ' Afaceri' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                    ...
                    <section class="directory-discover-section" id="business-tab">
                        <div class="container">
                            <div class="section-title-wrp d-flex">
                                <div class="section-title text-center">
                                    <h2>{{ __('Descopera afaceri') }}</h2>
                                    <p>{{ __('Navigheaza pe V-Card.ro. Poti sa gasesti lucruri esentiale pentru afacerea ta. Solutia perfecta de care ai nevoie! Totul intr-un singur loc.') }}
                                    </p>
                                </div>
