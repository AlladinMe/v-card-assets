...
Route::prefix('landing-page')->group(function(){
    ...
    Route::resource('business-campaigns', BusinessCampaignController::class);
...
Route::get('directory/home', 'MarketplaceController@index')->name('marketplace.home')->middleware('CheckPlan');
Route::get('directory/search', [MarketplaceController::class, 'search'])->name('business.search')->middleware('CheckPlan');
Route::get('directory/share/{slug}', [MarketplaceController::class, 'share'])->name('bussiness.share')->middleware('CheckPlan');
Route::get('directory/card-view/{slug}', [MarketplaceController::class, 'cardView'])->name('bussiness.view')->middleware('CheckPlan');
Route::get('directory/contact-view/{id}', [MarketplaceController::class, 'contactData'])->name('bussiness.contact')->middleware('CheckPlan');
